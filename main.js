  ...
  .then(function(data) {
    d3.json(base_url + "us-states.json")
      ...
      g.append("g")
          ...
          .enter()
          .append("g")
          .attr("fill", function(d) { console.log('1:' + d); return z(d.key); })
          .selectAll("rect")
          .data(function(d) { console.log('2:' + d); return d; })
          .enter()
          .append("rect")
          .attr("x", function(d) { console.log('3:' + d); return y(d[1]); })
          .attr("y", function(d) { console.log('4:' + d); return x(d.data['city']); })
          .attr("height", y.bandwidth())
          .attr("width", function(d) { console.log('5:' + d); /*return x(d[0]) - x(d[1]);*/ return 100; });
